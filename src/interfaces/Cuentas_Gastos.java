 ...
 * @author Jorge-L
 */
public class Cuentas_Gastos extends SourceJForm {

    /**
     * Creates new form Cuentas_Gastos
     */
    public Cuentas_Gastos() throws ClassNotFoundException, Exception {
        super();
        initComponents();
    }
    ...
    private void eliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_eliminarActionPerformed
        ...
        if(n==JOptionPane.YES_OPTION){
            try {
                PreparedStatement statement = rawConnection.prepareStatement("DELETE FROM cuentas_gastos WHERE id = ? ");
                ...
                Logger.getLogger(Cuentas_Gastos.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    private void btn_buscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_buscarActionPerformed
        try {
            PreparedStatement st = rawConnection.prepareStatement("SELECT * FROM cuentas_gastos WHERE id = ?");
    ...
    private void btn_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_guardarActionPerformed
        ...
        try {
            ...
            PreparedStatement statement = rawConnection.prepareStatement("INSERT INTO cuentas_gastos values(?,?,?,?,?,?)");
            statement.setString(1,tx_id.getText());
            //NOMBRE
            ...
            statement.setString(6,tx_fraccionamientos_id.getText());
    ...
    private void salvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_salvarActionPerformed
        try {
            PreparedStatement statement = rawConnection.prepareStatement(""
                ...
                + " WHERE id = ? ");
            //NOMBRE
            statement.setString(1,tx_importe.getText());
            //RAZON SOCIAL
            statement.setString(2,tx_fecha.getText());
            //DIRECCION
            statement.setString(3,tx_estado.getText());
            //CONTACTO
            statement.setString(4,tx_recibos_numero_recibo.getText());
            //ID
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cuentas_Gastos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
